    ...
    public function getTableRecentOrders()
    {
        ...
        foreach ($orders as $order) {
            ...
            $tr[] = [
                ...
                'value' => '',
                'class' => 'text-right',
                'wrapper_start' => '<a class="btn btn-default" href="' . $this->context->link->getAdminLink('AdminOrders', true) . '&id_order=' . (int) $order['id_order'] . '&vieworder" title="' . $this->trans('Details', [], 'Modules.Dashproducts.Admin') . '"><i class="icon-search"></i>',
                'wrapper_end' => '</a>',
            ];
